...
$$ = $.fn.galleria = function($options) {
	...
	return this.each(function(){
		...
		$(this).children('li').each(function(i) {
			...
			// find a Description
			var _longdesc = _a ? _a.attr('title') : _img.attr('title');
...
$$.onPageLoad = function(_src) {	
	...
	if (_src) {
		...
		if($.galleria.clickNext) {
			...
			// insert the caption
			_wrapper.siblings('.caption').html(unescape(_thumb.attr('title'))).css('cursor', 'pointer').click(function() { window.location = link; });
